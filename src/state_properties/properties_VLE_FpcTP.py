...
##############################################################################
"""
Alkene phase equilibrium package using Peng-Robinson liquid and vapor.
...
configuration = {
    ...
    "state_bounds": {"flow_mol_phase_comp": (0, 100, 5000, pyunits.mol / pyunits.s),
                     "temperature": (270.15, 300, 1500, pyunits.K),
